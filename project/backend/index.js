...
app.post('/AllCourses', async (req, res) => {
    try {
        ...
        console.error('Unable to retrieve all courses', error)
    } 
})
...
app.post('/mark_complete', async (req, res) => {
    try {
        ...
        console.error('Unable to mark task as complete', error)
    }
})
...
app.post('/mark_incomplete', async (req, res) => {
    try {
        ...
        console.error('Unable to mark task as incomplete', error)
    }
})
...
app.post('/getcourses', async (req, res) => {
    try {
        ...
        console.error('Unable to retrieve all courses and tasks for this user', error)
    }
})
...
app.post('/get_tasks', async (req, res) => {
    try {
        ...
        console.error('Unable to retrieve all tasks for this class', error)
    }
})
